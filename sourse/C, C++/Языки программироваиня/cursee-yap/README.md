Ранее был создан проект игры Эрудит с графикой на основе библиотеке SFML. Данная версия - только в консоли и в ней играют 2 компьютера (слабый алгоритм и умный).
## Задача: 
...
Более подробно с работой можно ознакомиться в [отчете](sourse/C,%20C++/Языки%20программироваиня/cursee-yap/Otchyot_2024.docx).