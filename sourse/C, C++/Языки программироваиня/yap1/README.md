...
Далее были сравнены оптимизации при флагах O0 и O3. Более подробные результаты сравнения можно увидеть в таблице на 12-15 страницах [отчета](sourse/C,%20C++/Языки%20программироваиня/yap1/Отчет1_Черникова.docx).
