...
В рамках выполнения работы необходимо разработать программу и dll-библиотеку, которые обеспечивают два режима работы:
...
2. **Изменение поведения функций** FindFirstFile, FindNextFile, CreateFile таким образом, что **для целевого процесса пропадает указанный заранее файл**. Для изменения поведения достаточно изменять значения, возвращаемые этими функциями в соответствии с определенными входными параметрами.
...
_Рисунок_ _ниже _- Код инжектора_
...
_Рисунок ниже - Мониторинг вызовов_

![](/img/Pasted%20image%2020250619013847.png)


_Рисунок_ _ниже_ _-_ _Сокрытие файла_
