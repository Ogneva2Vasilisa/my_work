...
#   define PNG_not_enabled 1
   /* enabled by */
#   ifndef PNG_WRITE_cICP_SUPPORTED /*!command line*/
#    ifdef PNG_not_enabled /*!enabled*/
#      ifdef PNG_NO_WRITE_cICP
#       undef PNG_on /*turned off*/
#      endif
#      ifdef PNG_NO_WRITE_cICP_SUPPORTED
#       undef PNG_on /*turned off*/
#      endif
#    endif /*!enabled*/
#    ifdef PNG_on
...
#   endif /*!command line*/
#   ifdef PNG_on
 PNG_DFN "#define PNG_WRITE_cICP_SUPPORTED" 
#   endif /* definition */
#endif /*requires, if*/
#ifndef  PNG_on
 PNG_DFN "/*#undef PNG_WRITE_cICP_SUPPORTED*/" 
#endif
...
#   define PNG_not_enabled 1
   /* enabled by */
#   ifndef PNG_READ_mDCV_SUPPORTED /*!command line*/
#    ifdef PNG_not_enabled /*!enabled*/
#      ifdef PNG_NO_READ_mDCV
#       undef PNG_on /*turned off*/
#      endif
#      ifdef PNG_NO_READ_mDCV_SUPPORTED
#       undef PNG_on /*turned off*/
#      endif
#    endif /*!enabled*/
#    ifdef PNG_on
...
#   endif /*!command line*/
#   ifdef PNG_on
 PNG_DFN "#define PNG_READ_mDCV_SUPPORTED" 
#   endif /* definition */
#endif /*requires, if*/
#ifndef  PNG_on
 PNG_DFN "/*#undef PNG_READ_mDCV_SUPPORTED*/" 
#endif
...
#   define PNG_not_enabled 1
   /* enabled by */
#   ifndef PNG_READ_cICP_SUPPORTED /*!command line*/
#    ifdef PNG_not_enabled /*!enabled*/
#      ifdef PNG_NO_READ_cICP
#       undef PNG_on /*turned off*/
#      endif
#      ifdef PNG_NO_READ_cICP_SUPPORTED
#       undef PNG_on /*turned off*/
#      endif
#    endif /*!enabled*/
#    ifdef PNG_on
...
#   endif /*!command line*/
#   ifdef PNG_on
 PNG_DFN "#define PNG_READ_cICP_SUPPORTED" 
#   endif /* definition */
#endif /*requires, if*/
#ifndef  PNG_on
 PNG_DFN "/*#undef PNG_READ_cICP_SUPPORTED*/" 
#endif
...
#   define PNG_not_enabled 1
   /* enabled by */
#   ifndef PNG_WRITE_cLLI_SUPPORTED /*!command line*/
#    ifdef PNG_not_enabled /*!enabled*/
#      ifdef PNG_NO_WRITE_cLLI
#       undef PNG_on /*turned off*/
#      endif
#      ifdef PNG_NO_WRITE_cLLI_SUPPORTED
#       undef PNG_on /*turned off*/
#      endif
#    endif /*!enabled*/
#    ifdef PNG_on
...
#   endif /*!command line*/
#   ifdef PNG_on
 PNG_DFN "#define PNG_WRITE_cLLI_SUPPORTED" 
#   endif /* definition */
#endif /*requires, if*/
#ifndef  PNG_on
 PNG_DFN "/*#undef PNG_WRITE_cLLI_SUPPORTED*/" 
#endif
 ...
 *   requires:  
 *   if:        
 *   enabled-by: READ_cICP WRITE_cICP READ_gAMA WRITE_gAMA READ_iCCP WRITE_iCCP READ_sRGB WRITE_sRGB
 *   sets:       */
#undef PNG_on
#define PNG_on 1
#undef PNG_no_if
...
#   undef PNG_not_enabled /*READ_cICP*/
#endif
#ifdef PNG_WRITE_cICP_SUPPORTED
#   undef PNG_not_enabled /*WRITE_cICP*/
#endif
...
#   define PNG_not_enabled 1
   /* enabled by */
#   ifndef PNG_READ_cLLI_SUPPORTED /*!command line*/
#    ifdef PNG_not_enabled /*!enabled*/
#      ifdef PNG_NO_READ_cLLI
#       undef PNG_on /*turned off*/
#      endif
#      ifdef PNG_NO_READ_cLLI_SUPPORTED
#       undef PNG_on /*turned off*/
#      endif
#    endif /*!enabled*/
#    ifdef PNG_on
...
#   endif /*!command line*/
#   ifdef PNG_on
 PNG_DFN "#define PNG_READ_cLLI_SUPPORTED" 
#   endif /* definition */
#endif /*requires, if*/
#ifndef  PNG_on
 PNG_DFN "/*#undef PNG_READ_cLLI_SUPPORTED*/" 
#endif
...
#   define PNG_not_enabled 1
   /* enabled by */
#   ifndef PNG_WRITE_mDCV_SUPPORTED /*!command line*/
#    ifdef PNG_not_enabled /*!enabled*/
#      ifdef PNG_NO_WRITE_mDCV
#       undef PNG_on /*turned off*/
#      endif
#      ifdef PNG_NO_WRITE_mDCV_SUPPORTED
#       undef PNG_on /*turned off*/
#      endif
#    endif /*!enabled*/
#    ifdef PNG_on
...
#   endif /*!command line*/
#   ifdef PNG_on
 PNG_DFN "#define PNG_WRITE_mDCV_SUPPORTED" 
#   endif /* definition */
#endif /*requires, if*/
#ifndef  PNG_on
 PNG_DFN "/*#undef PNG_WRITE_mDCV_SUPPORTED*/" 
#endif
...
/* option: mDCV disabled
 *   requires:  
 *   if:        
 *   enabled-by: READ_mDCV WRITE_mDCV
 *   sets:       */
#undef PNG_on
#define PNG_on 1
#undef PNG_no_if
...
#   undef PNG_not_enabled /*READ_mDCV*/
#endif
#ifdef PNG_WRITE_mDCV_SUPPORTED
#   undef PNG_not_enabled /*WRITE_mDCV*/
#endif
#   ifndef PNG_mDCV_SUPPORTED /*!command line*/
#    ifdef PNG_not_enabled /*!enabled*/
#      undef PNG_on /*default off*/
#    endif /*!enabled*/
#    ifdef PNG_on
...
#   endif /*!command line*/
#   ifdef PNG_on
 PNG_DFN "#define PNG_mDCV_SUPPORTED" 
#   endif /* definition */
#endif /*requires, if*/
#ifndef  PNG_on
 PNG_DFN "/*#undef PNG_mDCV_SUPPORTED*/" 
#endif
...
/* option: cICP disabled
 *   requires:  
 *   if:        
 *   enabled-by: READ_cICP WRITE_cICP
 *   sets:       */
#undef PNG_on
#define PNG_on 1
#undef PNG_no_if
...
#   undef PNG_not_enabled /*WRITE_cICP*/
#endif
#   ifndef PNG_cICP_SUPPORTED /*!command line*/
#    ifdef PNG_not_enabled /*!enabled*/
#      undef PNG_on /*default off*/
#    endif /*!enabled*/
#    ifdef PNG_on
...
#   endif /*!command line*/
#   ifdef PNG_on
 PNG_DFN "#define PNG_cICP_SUPPORTED" 
#   endif /* definition */
#endif /*requires, if*/
#ifndef  PNG_on
 PNG_DFN "/*#undef PNG_cICP_SUPPORTED*/" 
#endif
...
/* option: cLLI disabled
 *   requires:  
 *   if:        
 *   enabled-by: READ_cLLI WRITE_cLLI
 *   sets:       */
#undef PNG_on
#define PNG_on 1
#undef PNG_no_if
...
#   undef PNG_not_enabled /*READ_cLLI*/
#endif
#ifdef PNG_WRITE_cLLI_SUPPORTED
#   undef PNG_not_enabled /*WRITE_cLLI*/
#endif
#   ifndef PNG_cLLI_SUPPORTED /*!command line*/
#    ifdef PNG_not_enabled /*!enabled*/
#      undef PNG_on /*default off*/
#    endif /*!enabled*/
#    ifdef PNG_on
...
#   endif /*!command line*/
#   ifdef PNG_on
 PNG_DFN "#define PNG_cLLI_SUPPORTED" 
#   endif /* definition */
#endif /*requires, if*/
#ifndef  PNG_on
 PNG_DFN "/*#undef PNG_cLLI_SUPPORTED*/" 
#endif
 ...
 *   requires:  
 *   if:        
 *   enabled-by: READ_RGB_TO_GRAY READ_cHRM WRITE_cHRM READ_cICP WRITE_cICP READ_mDCV WRITE_mDCV
 *   sets:       */
#undef PNG_on
#define PNG_on 1
#undef PNG_no_if
...
#   undef PNG_on /*!READ_sRGB*/
#endif
#ifndef PNG_READ_mDCV_SUPPORTED
#   undef PNG_on /*!READ_mDCV*/
#endif
#ifndef PNG_READ_cICP_SUPPORTED
#   undef PNG_on /*!READ_cICP*/
#endif
