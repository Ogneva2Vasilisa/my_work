typedef struct ls {
    unsigned long long data; // поле данных какого-либо произвольного типа
...
ls* tail5 = lin_list5;
ls* tail7 = lin_list7;
unsigned long long massiv[5000];
unsigned long long last = 7;
FILE* yy;
int over = 0;
int K = 4;

void PRINT(FILE* t1);
short prov(unsigned long long te) {
    int i1 = 1;
    while (massiv[i1] != 0) {
        //printf("==mas[%d] %llu==\n", i1, massiv[i1]);
...
void InsertionSort1(int n, unsigned long long mass[])
{
    unsigned long long newElement, location;
...
unsigned long long  getelem3()
{
    unsigned long long elem = lin_list3->data;
    ls* list1;
    list1 = (lin_list3);
    //free(list);
...
unsigned long long  getelem5()
{
    unsigned long long elem = lin_list5->data;
    ls* list1;
    list1 = (lin_list5);
    //free(list);
...
unsigned long long  getelem7()
{
    unsigned long long elem = lin_list7->data;
    ls* list1;
    list1 = (lin_list7);
    //free(list);
...
ls* addelem1(ls* head, ls* tail1, unsigned long long data)
{
...
ls* addelem(ls* head, ls* tail1, unsigned long long data1, unsigned long long temp)
{
    unsigned long long data = data1 * temp;
...
unsigned long long minna() {
    ...
    //if ((lin_list3->data > last && lin_list5->data > last) && lin_list7->data > last)
    {
        ...
        if (lin_list3->data < lin_list5->data && lin_list3->data < lin_list7->data)
        {
            ...
            {
                tail3 = addelem(lin_list3, tail3, lin_list3->data, (unsigned long long)powl(3, 1));
                tail3 = addelem(lin_list3, tail3, lin_list5->data, (unsigned long long)powl(3, 1));
                tail3 = addelem(lin_list3, tail3, lin_list7->data, (unsigned long long)powl(3, 1));
            }
            //проблема в tail
            last = getelem3();
        ...
        if (lin_list5->data < lin_list3->data && lin_list5->data < lin_list7->data)
        {
            ...
            {
                tail5 = addelem(lin_list5, tail5, lin_list3->data, (unsigned long long)powl(5, 1));
                tail5 = addelem(lin_list5, tail5, lin_list5->data, (unsigned long long)powl(5, 1));
                tail5 = addelem(lin_list5, tail5, lin_list7->data, (unsigned long long)powl(5, 1));
            }
            last = getelem5();
            tail3 = addelem(lin_list3, tail3, last, 3);
            tail5 = addelem(lin_list5, tail5, last, 5);
        ...
        if (lin_list7->data < lin_list5->data && lin_list7->data < lin_list3->data)
        {
            ...
            {
                tail7 = addelem(lin_list7, tail7, lin_list3->data, (unsigned long long)powl(7, 1));
                tail7 = addelem(lin_list7, tail7, lin_list5->data, (unsigned long long)powl(7, 1));
                tail7 = addelem(lin_list7, tail7, lin_list7->data, (unsigned long long)powl(7, 1));
            }
            last = getelem7();
            tail3 = addelem(lin_list3, tail3, last, 3);
            tail5 = addelem(lin_list5, tail5, last, 5);
