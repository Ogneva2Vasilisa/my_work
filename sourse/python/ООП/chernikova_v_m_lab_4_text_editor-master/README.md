...
**Воссоздать текстовый редактор VIM с помощью паттернов проектирования, используя Python и написанную заранее библиотеку на C++.**
...
Более подробно с проектом можно ознакомиться в [отчете](sourse/Python/ООП/chernikova_v_m_lab_4_text_editor-master/Черникова_Отчет.docx)